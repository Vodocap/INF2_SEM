 ...
 * @author Matúš Uhlár
 */
public class Boss extends Bojovnik {
    ...
    private int celkovoNazbieranyDamage;
    ...
    public void pouziSpecialnuSchopnost(Hrac hrac) {
        this.poskodenie += 2;
        this.celkovoNazbieranyDamage += 2;
    }
    ...
    public void vypisInformacieOBojovnikovi(boolean podrobne) {
        if (podrobne) {
            System.out.println("Bojovnik typu: Boss ");
            ...
            System.out.println("Schopnost: s kazdym utokom sa jeho poskodenie zvysi o 2");
            System.out.println("");
        } else {
            System.out.print("Boss (Zivoty: " + (new DecimalFormat("###")).format(this.getPercentaZivotov()) + "%) ");
        }
    }
    ...
    public HashMap<String, Integer> dajStatistiky() {
        ...
        vysledok.put("Celkový nazbieraný damage bossov: ", this.celkovoNazbieranyDamage);
